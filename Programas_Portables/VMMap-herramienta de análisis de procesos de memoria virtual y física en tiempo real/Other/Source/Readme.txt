DEVELOPER: Replace the three occurrences of VMMapPortable in this file
...
user in an INI file next to VMMapPortable.exe called VMMapPortable.ini.
...
copy AppNamePortable.ini from this directory to VMMapPortable.ini next to
VMMapPortable.exe. The options in the INI file are as follows:
